...
public class BlockAttachedEntityMixin {
    ...
    @WrapOperation(method = "damage", at = @At(value = "INVOKE", target = "Lnet/minecraft/entity/decoration/BlockAttachedEntity;isRemoved()Z"))
    private boolean onDamage(BlockAttachedEntity instance, Operation<Boolean> original, ServerWorld world, DamageSource source, float amount) {
